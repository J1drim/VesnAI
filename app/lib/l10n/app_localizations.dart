...
abstract class AppLocalizations {
  ...
  /// No description provided for @completionNotificationsExplanation.
  ///
  /// In en, this message translates to:
  /// **'Notify when requested work finishes on this device. Turning this off does not stop background work or sync.'**
  String get completionNotificationsExplanation;

  /// No description provided for @aiBehavior.
  ///
  /// In en, this message translates to:
  /// **'AI behavior and availability'**
  String get aiBehavior;

  /// No description provided for @automaticImages.
  ///
  /// In en, this message translates to:
  /// **'Automatic note images'**
  String get automaticImages;

  /// No description provided for @automaticCritiques.
  ///
  /// In en, this message translates to:
  /// **'Automatic Marena critiques'**
  String get automaticCritiques;

  /// No description provided for @serverManagedBehavior.
  ///
  /// In en, this message translates to:
  /// **'Controlled by server configuration. Optional enrichment can also be requested from a note’s menu.'**
  String get serverManagedBehavior;

  /// No description provided for @serviceDemo.
  ///
  /// In en, this message translates to:
  /// **'Demo provider — not a live service'**
  String get serviceDemo;

  /// No description provided for @serviceAvailable.
  ///
  /// In en, this message translates to:
  /// **'Available at last explicit check'**
  String get serviceAvailable;

  /// No description provided for @serviceUnchecked.
  ///
  /// In en, this message translates to:
  /// **'Configured — availability not checked'**
  String get serviceUnchecked;

  /// No description provided for @servicesUnavailable.
  ///
  /// In en, this message translates to:
  /// **'Unavailable or not reported by this server'**
  String get servicesUnavailable;

  /// No description provided for @checkServices.
  ///
  /// In en, this message translates to:
  /// **'Check chat and embeddings'**
  String get checkServices;

  /// No description provided for @serviceCheckExplanation.
  ///
  /// In en, this message translates to:
  /// **'This sends one small chat request and one embedding request to the configured providers and may incur their normal costs. Images, voice and critiques are never generated by this check.'**
  String get serviceCheckExplanation;

  /// No description provided for @sharedInbox.
  ///
  /// In en, this message translates to:
  /// **'Shared inbox'**
  String get sharedInbox;

  /// No description provided for @sharedInboxExplanation.
  ///
  /// In en, this message translates to:
  /// **'Shared text, URLs and files are saved here offline without replacing your capture draft. Open a note to review/edit it; File away removes its inbox tag. Links are saved as sources, not automatically fetched.'**
  String get sharedInboxExplanation;

  /// No description provided for @fileAway.
  ///
  /// In en, this message translates to:
  /// **'File away'**
  String get fileAway;

  /// No description provided for @possibleDuplicateSource.
  ///
  /// In en, this message translates to:
  /// **'This source was captured before — open the earlier note'**
  String get possibleDuplicateSource;

  /// No description provided for @sharedImportRetry.
  ///
  /// In en, this message translates to:
  /// **'Some shared content could not be imported. It remains in the native inbox; reopen the app to retry.'**
  String get sharedImportRetry;

  /// No description provided for @pendingSharedImport.
  ///
  /// In en, this message translates to:
  /// **'Awaiting import'**
  String get pendingSharedImport;

  /// No description provided for @discardSharedImport.
  ///
  /// In en, this message translates to:
  /// **'Discard unimported share'**
  String get discardSharedImport;

  /// No description provided for @discardSharedImportConfirm.
  ///
  /// In en, this message translates to:
  /// **'Discard this native intake copy? The original in the sharing app is not changed. This cannot be undone.'**
